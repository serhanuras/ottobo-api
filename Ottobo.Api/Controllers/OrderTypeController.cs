...
namespace Ottobo.Api.Controllers
{
    ...
    public class OrderTypeController  : OttoboBaseController<OrderType, OrderTypeDto, OrderTypeCreationDto,OrderTypeFilterDto, OrderTypePatchDto>
    {
        ...
        public  ActionResult<IEnumerable<OrderTypeDto>> Get([FromQuery] PaginationDto paginationDto)
        {
        ...
        [HttpGet("{id}")]
        public ActionResult<OrderTypeDto> Get(long id)
        {
            return base.Get(id);
        }
        ...
        /// <returns></returns>
        [HttpPost]
        public ActionResult Post(OrderTypeCreationDto creationDto)
        {
        ...
        /// <returns></returns>
        [HttpPut("{id:int}")]
        public ActionResult Put(int id, OrderTypeCreationDto updateDTO)
        {
