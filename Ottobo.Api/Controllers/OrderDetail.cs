...
namespace Ottobo.Api.Controllers
{
    ...
    public class OrderDetailController :CustomControllerBase<OrderDetail, OrderDetailDto, OrderDetailCreationDto, OrderDetailFilterDto, OrderDetailPatchDto>
    {

        public OrderDetailController(ILogger<OrderType> logger, 
            ApplicationDbContext dbContext, 
            IMapper mapper, 
            OrderDetailService orderDetailService) : 
                base(logger, mapper, orderDetailService, "MasterData>PurchaseType")
        {
        ...
        [HttpGet("{id}")]
        public new ActionResult<OrderDetailDto> Get(long id)
        {
            return base.Get(id);
        }
        ...
        /// <returns></returns>
        [HttpPut("{id:int}")]
        public new ActionResult Put(int id, OrderDetailCreationDto updateDTO)
        {
        ...
        /// <returns></returns>
        [HttpPatch("{id}")]
        public new ActionResult Patch(int id, JsonPatchDocument<OrderDetailPatchDto> patchDocument)
        {
