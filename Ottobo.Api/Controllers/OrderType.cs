...
namespace Ottobo.Api.Controllers
{
    ...
    public class OrderTypeController  : CustomControllerBase<OrderType, OrderTypeDto, OrderTypeCreationDto,OrderTypeFilterDto, OrderTypePatchDto>
    {
        ...
        public OrderTypeController(ILogger<OrderType> logger,
            IMapper mapper, 
        ...
        [HttpGet("{id}")]
        public new ActionResult<OrderTypeDto> Get(long id)
        {
            return base.Get(id);
        }
        ...
        /// <returns></returns>
        [HttpPut("{id:int}")]
        public new ActionResult Put(int id, OrderTypeCreationDto updateDTO)
        {
